function [alarm,env] = hilbert_envelop(y,Smooth_window,threshold_style,DURATION,gr)
%%% ======================= Inputs ================================ %%
...
%-------------------------------------------------------------------------
% REFERENCE: 
% Sedghamiz, H. BioSigKit: A Matlab Toolbox and Interface for Analysis of BioSignals Software 
% • Review • Repository Archive. J. Open Source Softw. 2018, 3, 671
%%
%--------------------------- input handling ---------------------------%
if nargin < 5
    gr = 1;
